...
function contactValidation(e) {
  ...
  //     const errorDisplay = inputControl.querySelector(".contact-form-error");

  //     errorDisplay.innerText = message;
  //     inputControl.classList.add("contact-form-error");
  ...
  //     inputControl.classList.remove("contact-form-error");
  //   };
